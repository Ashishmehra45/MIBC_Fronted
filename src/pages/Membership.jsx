    ...
    <div className="min-h-screen bg-[#faf9f6] font-sans">
      ...
      <section className="relative h-[600px] md:h-[750px] flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4">
          <span className="bg-white text-[#A98842] px-6 py-2 rounded-full text-[11px] font-black uppercase tracking-[0.3em] mb-8 inline-block shadow-2xl animate-fade-in">
            Membership
          </span>
          <h1 className="text-white text-5xl md:text-8xl font-black mb-8 tracking-tighter leading-tight drop-shadow-2xl">
            {content.hero.title}
          </h1>
          <p className="max-w-3xl mx-auto text-gray-200 text-lg md:text-2xl font-medium leading-relaxed mb-12 opacity-90 drop-shadow-lg">
            {content.hero.desc}
          </p>
      ...
      <section className="py-24 px-4">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="text-center mb-16">
            <span className="text-[#A98842] text-[11px] font-black tracking-widest uppercase bg-[#FFF9E6] px-4 py-1 rounded-md">
              Who Should Join
            </span>
            <h2 className="text-4xl md:text-6xl font-black text-gray-900 mt-4 tracking-tight">
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {content.benefits.map((benefit, i) => (
              <div
                key={i}
                className="relative rounded-[40px] overflow-hidden h-[400px] group shadow-2xl border border-gray-50"
              >
                <img
                  src={benefit.img}
                  className="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110"
      ...
      <section className="py-32 px-4 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-96 h-96 bg-[#A98842]/5 rounded-full blur-[100px] -z-10"></div>

        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-24">
            <span className="bg-[#FFF9E6] text-[#A98842] px-6 py-2 rounded-xl text-[11px] font-black uppercase tracking-[0.2em] shadow-sm">
              How To Apply
            </span>
            <h2 className="text-5xl md:text-7xl font-black text-gray-900 mt-8 tracking-tighter">
          ...
          <div className="relative flex flex-col md:flex-row justify-between items-start gap-16 md:gap-4 px-6 md:px-12">
            ...
            <div className="hidden md:block absolute top-[88px] left-[10%] right-[10%] h-[2px] bg-gray-200 -z-0"></div>
            ...
            {content.journey.map((item, i) => (
              ...
              >
                {/* Circle Step */}
                <div
                  className={`w-40 h-40 md:w-44 md:h-44 rounded-full ${item.color} flex items-center justify-center mb-10 border-8 border-[#faf9f6] shadow-xl transition-all duration-500 group-hover:rotate-6 group-hover:scale-110 group-hover:shadow-[#A98842]/20`}
                >
                ...
                {/* Text Content */}
                <h3 className="text-2xl font-black text-gray-950 mb-4 transition-colors group-hover:text-[#A98842]">
                  {item.title}
                </h3>
                <p className="text-gray-500 text-[15px] font-medium leading-relaxed opacity-80">
                  {item.desc}
                </p>
              </div>
            ))}
      ...
      <div className="fixed bottom-10 right-10 w-12 h-12 bg-white/80 backdrop-blur shadow-xl rounded-full flex items-center justify-center cursor-pointer border border-gray-100 text-[#A98842] hover:bg-[#A98842] hover:text-white transition-all z-50">
