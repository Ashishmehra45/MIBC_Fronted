...
const Services = () => {
  ...
  return (
    <div className="min-h-screen bg-[#faf9f6] dark:bg-slate-950 font-sans overflow-x-hidden transition-colors duration-500">
              ...
              >
                <div className="relative h-full w-full transition-all duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] cursor-pointer">
                  ...
                  <div className="absolute inset-0 h-full w-full rounded-[32px] bg-[#1a1a1a] dark:bg-slate-900 p-10 flex flex-col justify-center [transform:rotateY(180deg)] [backface-visibility:hidden] border-2 border-[#A98842]/30 transition-colors">
                    <h3 className="text-[#A98842] text-xl font-black mb-8 border-b border-[#A98842]/20 pb-4">
                      {card.title}
                    </h3>
                    <ul className="space-y-4">
                      {card.backContent.map((point, i) => (
                        <li
                          key={i}
                          className="flex items-start gap-3 text-gray-300 dark:text-gray-400 text-sm font-bold transition-colors"
                        >
                          <ChevronRight
                            size={16}
                            className="text-[#A98842] shrink-0 mt-0.5"
                          />
      ...
      <section className="py-16 md:py-24 bg-[#faf9f6] dark:bg-slate-900 relative overflow-hidden font-sans transition-colors duration-500">
        {/* Ambient Background Blob */}
        <div className="absolute top-0 right-0 w-64 md:w-96 h-64 md:h-96 bg-[#A98842]/5 dark:bg-[#A98842]/10 rounded-full blur-[80px] md:blur-[100px] -z-0 transition-colors"></div>
        ...
        <div className="container mx-auto max-w-6xl px-6 relative z-10">
          ...
          <div className="relative">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="absolute left-4 md:left-1/2 top-0 h-full w-[2px] bg-gradient-to-b from-[#A98842]/0 via-[#A98842]/40 to-[#A98842]/0 -translate-x-1/2 origin-top"
            ></motion.div>
              ...
              {processSteps.map((step, i) => (
                ...
                >
                  ...
                  <div className="w-full md:w-[45%] pl-12 md:pl-0 group">
                    <div
                      className={`bg-white dark:bg-slate-800 p-8 md:p-10 rounded-[30px] md:rounded-[35px] shadow-[0_10px_30px_rgba(0,0,0,0.02)] border border-gray-100 dark:border-slate-700 hover:border-[#A98842]/20 transition-all duration-500 hover:shadow-2xl relative text-left ${
                        step.align === "left" ? "md:text-right" : "md:text-left"
                      }`}
                    >
                      {/* Background Number */}
                      <span
                        className={`absolute top-4 font-black text-6xl md:text-7xl text-gray-400/5 dark:text-white/5 select-none transition-colors hidden md:block ${
                      ...
                      <h4 className="text-xl md:text-2xl font-black text-gray-950 dark:text-white mb-3 md:mb-4 tracking-tight group-hover:text-[#A98842] transition-colors">
                        {step.title}
                      </h4>
                      <p className="text-gray-500 dark:text-gray-400 text-sm md:text-[16px] leading-relaxed font-medium transition-colors">
                        {step.desc}
                      </p>
                    </div>
                  </div>
                  ...
                  {/* --- Circle Indicator --- */}
                  <div className="absolute left-4 md:left-1/2 top-10 md:top-auto z-10 flex items-center justify-center -translate-x-1/2">
                    <motion.div
                      initial={{ scale: 0 }}
                      whileInView={{ scale: 1 }}
                      transition={{
                      ...
                      className="w-8 h-8 md:w-14 md:h-14 rounded-full bg-white dark:bg-slate-800 border-[4px] md:border-[6px] border-[#faf9f6] dark:border-slate-900 shadow-xl flex items-center justify-center relative group-hover:scale-110 transition-transform"
                    >
                      <div className="w-5 h-5 md:w-8 md:w-8 rounded-full bg-[#A98842] flex items-center justify-center text-white font-black text-[8px] md:text-[10px] shadow-inner">
                        {step.step}
                      </div>
                      {/* Pulse Effect */}
            ...
            <table className="w-full text-left border-collapse min-w-[800px]">
              ...
              <tbody className="bg-white dark:bg-slate-900 transition-colors">
                {[
                  ...
                  >
                    <td className="p-8 font-black text-gray-950 dark:text-white text-sm transition-colors">
                      {row[0]}
                    </td>
                    <td className="p-8 text-gray-500 dark:text-gray-400 text-sm font-medium transition-colors">
                      {row[1]}
                    </td>
                    <td className="p-8 text-gray-500 dark:text-gray-400 text-sm font-medium transition-colors">
                      {row[2]}
                    </td>
                    <td className="p-8 font-black text-gray-900 dark:text-[#A98842] text-sm bg-[#A98842]/5 dark:bg-[#A98842]/10 transition-colors">
                      {row[3]}
                    </td>
                  </motion.tr>
                ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400 text-[14px] font-medium leading-relaxed transition-colors">
                  {text}
                </p>
              </motion.div>
            ))}
